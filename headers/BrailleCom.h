...
uint8_t BCLV_IMPRIMIENDO = 0;            //Se actualiza, desde la pc, si la impresora entra en modo de impresion. 1 = Se está imprimiendo, 0 = Se termino la impresion/No se está imprimiendo.
